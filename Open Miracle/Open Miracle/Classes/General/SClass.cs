    ...
    class SClass
    {
        ...
        internal bool CheckMsSqlConnection(string serverName, string userId, string password, string ApplicationPath)
        {
            ...
            if (serverName != null)
            {
                ...
                {
                    sqlcon = new SqlConnection(@"Data Source=" + serverName + ";AttachDbFilename=" + ApplicationPath + "\\Data\\DBOpenmiracle.mdf" + ";Integrated Security=True;Connect Timeout=30;User Instance=True");
                }
                else
                {
                ...
                catch (SqlException ex)
                {
                    if (ex.Number == 18493)
                    {
                        if (userId == null || password == null)
                        {
                            sqlcon = new SqlConnection(@"Data Source=" + serverName + ";AttachDbFilename=" + ApplicationPath + "\\Data\\DBOpenmiracle.mdf" + ";Integrated Security=True;Connect Timeout=30");
                        }
                        else
                        {
                            sqlcon = new SqlConnection(@"Data Source=" + serverName + ";AttachDbFilename=" + ApplicationPath + "\\Data\\DBOpenmiracle.mdf" + ";user id='" + userId + "';password='" + password + "'; Connect Timeout=30");
                        }
                        try
                        {
                            sqlcon.Open();
